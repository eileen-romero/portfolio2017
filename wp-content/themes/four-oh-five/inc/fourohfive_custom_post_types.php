...
// PORTFOLIOS
  ...
  register_post_type( 'fourohfive_portfolio', $argsPortfolio );
}
...
function create_taxonomies() {
  ...
  register_taxonomy('fourohfive_project_type',array('fourohfive_portfolio'),$args);
  ...
  register_taxonomy('fourohfive_project_attribute','fourohfive_portfolio',$args);
}
